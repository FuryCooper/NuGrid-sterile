    ...
    P%xi_nu(1) = Ini_Read_Double('xi_nu1') !Kenny: edited terry
    P%xi_nu(2) = Ini_Read_Double('xi_nu2') !Kenny: edited terry
    P%xi_nu(3) = Ini_Read_Double('xi_nu3') !Kenny: edited terry
    P%input_Allxi_on = Ini_Read_Logical('input_Allxi_on', .false.) !Rui
