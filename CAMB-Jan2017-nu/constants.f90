    ...
    real(dl), parameter :: c = 2.9979246e8_dl
    real(dl), parameter :: h_P = 6.6260701e-34_dl
    real(dl), parameter :: hbar = h_P/const_twopi

    real(dl), parameter :: G=6.6743e-11_dl !data book 2012, last digit +/-8
    ...
    real(dl), parameter :: Mpc = 3.085677581e22_dl !seem to be different definitions of this?
    ...
    real(dl), parameter :: s12sq = 0.304, s23sq = 0.51, s13sq = 0.0219 !terry
    real(dl), parameter :: s12 = sqrt(s12sq), s23 = sqrt(s23sq), s13 = sqrt(s13sq) !terry
    real(dl), parameter :: c12 = sqrt(1.d0-s12sq), c23 = sqrt(1.d0-s23sq), c13 = sqrt(1.d0-s13sq) !terry
    real(dl), parameter :: t12 = s12/c12, t23 = s23/c23, t13 = s13/c13 !terry
    real(dl), parameter :: r23 = ((1 - t13**2*(1 - t12**2))*(c23**2 - s23**2) + 2*t12*t13**2*s13*2*s23*c23)/& !terry
        ((1 - t12**2)*(c23**2 - s23**2) - 2*s13*t12*2*s23*c23) !terry   zzc
