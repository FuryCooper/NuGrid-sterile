...
TOOLTEST tarray1_big.ddl --enable-error-stack -R tarray1_big.h5
...
TOOLTEST  tdataregR.ddl --enable-error-stack -R tdatareg.h5
TOOLTEST  tattrreg.ddl --enable-error-stack tattrreg.h5
TOOLTEST  tattrregR.ddl --enable-error-stack -R tattrreg.h5
