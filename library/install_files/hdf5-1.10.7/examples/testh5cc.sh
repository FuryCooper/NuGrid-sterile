...
prefix="${prefix:-/home/wzzhang/library/hdf5}"
...
temp_SRC="$hdf5main $v16main $v18main $v110main $appmain $prog1 $prog2"
...
# 20200610 Updated for version 1.10.
# If H5_NO_DEPRECATED_SYMBOLS;
# then versions v18main and v110main work.
