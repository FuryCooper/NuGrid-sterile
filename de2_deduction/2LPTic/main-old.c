...
int main(int argc, char **argv)
{
  ...
  read_parameterfile(argv[1]);
    ...
    Omega_nu0_expan = neutrino_integration(1.0, mass_nu_expan, xi_expan);
    Omega_nu0_frstr = neutrino_integration(1.0, mass_nu_frstr, xi_frstr);
...
void displacement_fields(void)
{
  ...
  if(ThisTask == 0)
    ...
    roneu = neutrino_integration(InitTime, mass_nu_expan, xi_expan);
