...
void advance_and_find_timesteps(void)
{
  ...
  if(All.ComovingIntegrationOn)
	...
	//only for one active/sterile neutrino and for one active + sterile neutrino
 	...
 	{
  	case 3:
    	roneu = neutrino_integration(All.Time, All.mass_1, All.xi_1) + neutrino_integration(All.Time, All.mass_3, All.xi_3);
    	break;

  	case 2:
    	roneu = neutrino_integration(All.Time, All.mass_3, All.xi_3);
    	break;
  	...
  	default:
		...
		hubble_a = All.Omega2 / (All.Time * All.Time * All.Time)
	+ (1 - All.Omega2 - All.OmegaLambda - All.Omega_nu0_expan) / (All.Time * All.Time) + All.OmegaLambda + roneu;

		//hubble_a = All.Omega0 / (All.Time * All.Time * All.Time)
	//+ (1 - All.Omega0 - All.OmegaLambda - roneu0) / (All.Time * All.Time) + All.OmegaLambda + roneu;
