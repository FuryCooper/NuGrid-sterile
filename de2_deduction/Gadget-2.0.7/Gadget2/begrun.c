...
void begrun(void)
{
  ...
  read_parameter_file(ParameterFile);	/* ... read in parameters for this run */
    ...
    if(All.lepton_asymmetry == 3){
    All.xi_2 = 0;
    All.xi_1 = 0.1;
    }

    if(All.lepton_asymmetry == 2){
    All.xi_2 = 0;
    All.xi_1 = 0;
    }
    ...
    if(All.mass_hierarchy == 3){
	    //only for one active/steriel neutrino
	    All.mass_2 = 0;
      All.mass_3 = All.mass_1;
	    All.mass_1 = 0;
    }

	  if(All.mass_hierarchy == 4){
    ...
    printf("m1 %f m2 %f m3 %f xi1 %f xi2 %f xi3 %f\n", All.mass_1, All.mass_2, All.mass_3, All.xi_1, All.xi_2, All.xi_3);
	  ...
	  //only for one active + sterile neutrino
	  if(All.expan_on == 3){
	    All.Omega_nu0_expan = neutrino_integration(1.0, All.mass_1, All.xi_1) + neutrino_integration(1.0, All.mass_3, All.xi_3);
    }    

    //only for one active/steriel neutrino
    if(All.expan_on == 2){
	    All.Omega_nu0_expan = neutrino_integration(1.0, All.mass_3, All.xi_3);
    }
